/*
  ...
  1. Creates sample users first to satisfy foreign key constraints
  2. Inserts sample data for all related tables
  3. Maintains referential integrity across all relationships
*/

-- First create the users
INSERT INTO auth.users (id, email, created_at, updated_at, raw_app_meta_data) VALUES
  ('11111111-1111-1111-1111-111111111111', 'sarah.chen@maryadha.com', NOW(), NOW(), '{"role": "rep"}'::jsonb),
  ('22222222-2222-2222-2222-222222222222', 'michael.rodriguez@maryadha.com', NOW(), NOW(), '{"role": "rep"}'::jsonb),
  ('33333333-3333-3333-3333-333333333333', 'emily.wong@maryadha.com', NOW(), NOW(), '{"role": "rep"}'::jsonb),
  ('44444444-4444-4444-4444-444444444444', 'contact@stellarleather.com', NOW(), NOW(), '{"role": "brand"}'::jsonb),
  ('55555555-5555-5555-5555-555555555555', 'info@urbanhide.com', NOW(), NOW(), '{"role": "brand"}'::jsonb),
  ('66666666-6666-6666-6666-666666666666', 'hello@artisanleather.com', NOW(), NOW(), '{"role": "brand"}'::jsonb);
...
INSERT INTO brands (id, name, website, email, logo_url) VALUES
  ('44444444-4444-4444-4444-444444444444', 'Stellar Leather Co.', 'https://stellarleather.com', 'contact@stellarleather.com', 'https://images.pexels.com/photos/1337380/pexels-photo-1337380.jpeg'),
  ('55555555-5555-5555-5555-555555555555', 'Urban Hide', 'https://urbanhide.com', 'info@urbanhide.com', 'https://images.pexels.com/photos/1337381/pexels-photo-1337381.jpeg'),
  ('66666666-6666-6666-6666-666666666666', 'Artisan Leather Works', 'https://artisanleather.com', 'hello@artisanleather.com', 'https://images.pexels.com/photos/1337382/pexels-photo-1337382.jpeg');
...
INSERT INTO samples (id, brand_id, factory_id, status, file_url, comments, rep_id, created_at) VALUES
  ('a1a2b3c4-d5e6-f7a8-b9c0-1d2e3f4a5b6c', '44444444-4444-4444-4444-444444444444', 'f1e2d3c4-b5a6-7c8d-9e0f-1a2b3c4d5e6f', 'in_review', 'https://example.com/samples/1.pdf', 'Looking for distressed finish with antique hardware', 'd1c7b6e9-0f3a-4b4d-8e5c-2f9a8b7c6d5e', NOW() - INTERVAL '2 months'),
  ('b2b3c4d5-e6f7-a8b9-c0d1-2e3f4a5b6c7d', '55555555-5555-5555-5555-555555555555', 'a2f3e4d5-c6b7-8d9e-0f1a-2b3c4d5e6f7b', 'approved', 'https://example.com/samples/2.pdf', 'Pebbled texture sample for upcoming collection', 'e2d8c7f0-1f4b-5c5e-9f6d-3a0b8c7d6e5f', NOW() - INTERVAL '6 weeks'),
  ('c3c4d5e6-f7a8-b9c0-d1e2-3f4a5b6c7d8e', '66666666-6666-6666-6666-666666666666', 'b3a4f5e6-d7c8-9e0f-1a2b-3c4d5e6f7a8c', 'requested', 'https://example.com/samples/3.pdf', 'Need samples in three different finishes', 'f3e9d8a1-2b5c-6d6f-0e7e-4b1c9d8e7f6a', NOW() - INTERVAL '2 weeks');
...
INSERT INTO orders (id, sample_id, brand_id, factory_id, status, quantity, unit_price, total_amount, currency, payment_status, estimated_delivery, rep_id, created_at) VALUES
  ('a1b2c3d4-e5f6-a7b8-c9d0-1e2f3a4b5c6d', 'a1a2b3c4-d5e6-f7a8-b9c0-1d2e3f4a5b6c', '44444444-4444-4444-4444-444444444444', 'f1e2d3c4-b5a6-7c8d-9e0f-1a2b3c4d5e6f', 'in_production', 200, 45.99, 9198.00, 'USD', 'partial', '2024-08-15', 'd1c7b6e9-0f3a-4b4d-8e5c-2f9a8b7c6d5e', NOW() - INTERVAL '3 weeks'),
  ('b2c3d4e5-f6a7-b8c9-d0e1-2f3a4b5c6d7e', 'b2b3c4d5-e6f7-a8b9-c0d1-2e3f4a5b6c7d', '55555555-5555-5555-5555-555555555555', 'a2f3e4d5-c6b7-8d9e-0f1a-2b3c4d5e6f7b', 'confirmed', 150, 52.99, 7948.50, 'USD', 'pending', '2024-09-01', 'e2d8c7f0-1f4b-5c5e-9f6d-3a0b8c7d6e5f', NOW() - INTERVAL '2 weeks'),
  ('c3d4e5f6-a7b8-c9d0-e1f2-3a4b5c6d7e8f', 'c3c4d5e6-f7a8-b9c0-d1e2-3f4a5b6c7d8e', '66666666-6666-6666-6666-666666666666', 'b3a4f5e6-d7c8-9e0f-1a2b-3c4d5e6f7a8c', 'pending', 100, 39.99, 3999.00, 'USD', 'pending', '2024-09-15', 'f3e9d8a1-2b5c-6d6f-0e7e-4b1c9d8e7f6a', NOW() - INTERVAL '1 week');

-- Insert sample messages
INSERT INTO messages (id, sender_id, receiver_id, text, created_at) VALUES
  ('a1b2c3d4-e5f6-a7b8-c9d0-1e2f3a4b5c6d', '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'Your sample request has been received and is being processed.', NOW() - INTERVAL '3 days'),
  ('b2c3d4e5-f6a7-b8c9-d0e1-2f3a4b5c6d7e', '22222222-2222-2222-2222-222222222222', '55555555-5555-5555-5555-555555555555', 'The factory has approved your sample. Would you like to proceed with the order?', NOW() - INTERVAL '2 days'),
  ('c3d4e5f6-a7b8-c9d0-e1f2-3a4b5c6d7e8f', '33333333-3333-3333-3333-333333333333', '66666666-6666-6666-6666-666666666666', 'I have some questions about your sample specifications. Can we schedule a call?', NOW() - INTERVAL '1 day');

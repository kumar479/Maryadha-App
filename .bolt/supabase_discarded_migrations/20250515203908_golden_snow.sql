/*
  # Update Factories Schema

  1. New Types
    - Create leather_type enum (Distressed, Polished, etc.)
    - Create tanning_type enum (Chrome, Vegetable)
    - Create finish_type enum (Distressed, Polished, etc.)

  2. Schema Changes
    - Add array columns for leather types, tanning types, and finishes

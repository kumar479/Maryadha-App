/*
  ...
  This migration adds realistic sample data to test relationships between tables.

  1. Sample Data Added:
    - Reps with user accounts
    - Brands with user accounts
    - Factories with various specialties
    - Samples with relationships
    - Orders with full relationships
    - Messages and notifications
    - Notification preferences

  2. Relationships:
    - Each rep has multiple samples and orders
    - Each brand has multiple samples and orders
    - Each factory has multiple samples and orders
    - Messages link between users
    - Notifications link to specific entities
...
INSERT INTO reps (id, user_id, name, email, phone, bio, profile_image, active, created_at) VALUES
  ('d1c7b6e9-0f3a-4b4d-8e5c-2f9a8b7c6d5e', 'auth_user_1', 'Sarah Chen', 'sarah.chen@maryadha.com', '+1234567890', 'Experienced sourcing expert specializing in luxury leather goods with 8+ years in the industry.', 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg', true, NOW() - INTERVAL '1 year'),
  ('e2d8c7f0-1g4b-5c5e-9f6d-3g0b8c7d6e5f', 'auth_user_2', 'Michael Rodriguez', 'michael.rodriguez@maryadha.com', '+1234567891', 'Former production manager turned sourcing expert, focusing on sustainable manufacturing practices.', 'https://images.pexels.com/photos/1181391/pexels-photo-1181391.jpeg', true, NOW() - INTERVAL '11 months'),
  ('f3e9d8g1-2h5c-6d6f-0g7e-4h1c9d8e7f6g', 'auth_user_3', 'Emily Wong', 'emily.wong@maryadha.com', '+1234567892', 'Quality assurance specialist with deep knowledge of leather processing and finishing techniques.', 'https://images.pexels.com/photos/1181695/pexels-photo-1181695.jpeg', true, NOW() - INTERVAL '9 months');
...
INSERT INTO notification_preferences (id, user_id, notification_type, email_enabled, push_enabled, whatsapp_enabled, created_at) VALUES
  ('n1o2p3q4-r5s6-t7u8-v9w0-1x2y3z4a5b6', 'd1c7b6e9-0f3a-4b4d-8e5c-2f9a8b7c6d5e', 'sample_request', true, true, true, NOW()),
  ('n2o3p4q5-r6s7-t8u9-v0w1-2x3y4z5a6b7', 'e2d8c7f0-1g4b-5c5e-9f6d-3g0b8c7d6e5f', 'order_update', true, true, false, NOW()),
  ('n3o4p5q6-r7s8-t9u0-v1w2-3x4y5z6a7b8', 'f3e9d8g1-2h5c-6d6f-0g7e-4h1c9d8e7f6g', 'message', true, true, true, NOW());

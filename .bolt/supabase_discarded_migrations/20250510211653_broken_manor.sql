/*
  ...
  This migration populates the database with initial sample data for testing and development.
  
  1. Data Structure
    - Reps with user associations
...
INSERT INTO reps (id, user_id, name, email, phone, bio, profile_image, active, created_at) VALUES
  ...
  ('f3e9d8a1-2h5c-6d6f-0e7e-4b1c9d8e7f6g', '33333333-3333-3333-3333-333333333333', 'Emily Wong', 'emily.wong@maryadha.com', '+1234567892', 'Quality assurance specialist with deep knowledge of leather processing and finishing techniques.', 'https://images.pexels.com/photos/1181695/pexels-photo-1181695.jpeg', true, NOW() - INTERVAL '9 months');
...
INSERT INTO brands (id, name, website, email, logo_url) VALUES
  ...
  ('b2c3d4e5-f6a7-5b6c-9d0e-2b3c4d5e6f7g', 'Urban Hide', 'https://urbanhide.com', 'info@urbanhide.com', 'https://images.pexels.com/photos/1337381/pexels-photo-1337381.jpeg'),
  ('c3d4e5f6-a7b8-6c7d-0e1f-3c4d5e6f7a8h', 'Artisan Leather Works', 'https://artisanleather.com', 'hello@artisanleather.com', 'https://images.pexels.com/photos/1337382/pexels-photo-1337382.jpeg');
...
INSERT INTO factories (id, name, location, description, minimum_order_quantity, leather_types, created_at) VALUES
  ...
  ('a2f3e4d5-c6b7-8d9e-0f1a-2b3c4d5e6f7g', 'Heritage Tannery', 'Delhi, India', 'Traditional tanning methods combined with modern technology', 100, ARRAY['Pebbled', 'Suede']::leather_type[], NOW() - INTERVAL '18 months'),
  ('b3a4f5e6-d7c8-9e0f-1a2b-3c4d5e6f7a8h', 'Modern Leather Solutions', 'Mumbai, India', 'Innovative leather processing techniques for contemporary designs', 75, ARRAY['Polished', 'Matte', 'Pebbled']::leather_type[], NOW() - INTERVAL '1 year');
...
INSERT INTO samples (id, brand_id, factory_id, status, file_url, comments, rep_id, created_at) VALUES
  ...
  ('b2b3c4d5-e6f7-a8b9-c0d1-2e3f4a5b6c7d', 'b2c3d4e5-f6a7-5b6c-9d0e-2b3c4d5e6f7g', 'a2f3e4d5-c6b7-8d9e-0f1a-2b3c4d5e6f7g', 'approved', 'https://example.com/samples/2.pdf', 'Pebbled texture sample for upcoming collection', 'e2d8c7f0-1f4b-5c5e-9f6d-3a0b8c7d6e5f', NOW() - INTERVAL '6 weeks'),
  ('c3c4d5e6-f7a8-b9c0-d1e2-3f4a5b6c7d8e', 'c3d4e5f6-a7b8-6c7d-0e1f-3c4d5e6f7a8h', 'b3a4f5e6-d7c8-9e0f-1a2b-3c4d5e6f7a8h', 'requested', 'https://example.com/samples/3.pdf', 'Need samples in three different finishes', 'f3e9d8a1-2h5c-6d6f-0e7e-4b1c9d8e7f6g', NOW() - INTERVAL '2 weeks');
...
INSERT INTO orders (id, sample_id, brand_id, factory_id, status, quantity, unit_price, total_amount, currency, payment_status, estimated_delivery, rep_id, created_at) VALUES
  ...
  ('b2c3d4e5-f6a7-b8c9-d0e1-2f3a4b5c6d7e', 'b2b3c4d5-e6f7-a8b9-c0d1-2e3f4a5b6c7d', 'b2c3d4e5-f6a7-5b6c-9d0e-2b3c4d5e6f7g', 'a2f3e4d5-c6b7-8d9e-0f1a-2b3c4d5e6f7g', 'confirmed', 150, 52.99, 7948.50, 'USD', 'pending', '2024-09-01', 'e2d8c7f0-1f4b-5c5e-9f6d-3a0b8c7d6e5f', NOW() - INTERVAL '2 weeks'),
  ('c3d4e5f6-a7b8-c9d0-e1f2-3a4b5c6d7e8f', 'c3c4d5e6-f7a8-b9c0-d1e2-3f4a5b6c7d8e', 'c3d4e5f6-a7b8-6c7d-0e1f-3c4d5e6f7a8h', 'b3a4f5e6-d7c8-9e0f-1a2b-3c4d5e6f7a8h', 'pending', 100, 39.99, 3999.00, 'USD', 'pending', '2024-09-15', 'f3e9d8a1-2h5c-6d6f-0e7e-4b1c9d8e7f6g', NOW() - INTERVAL '1 week');
...
INSERT INTO messages (id, sender_id, receiver_id, text, created_at) VALUES
  ...
  ('b2c3d4e5-f6a7-b8c9-d0e1-2f3a4b5c6d7e', 'e2d8c7f0-1f4b-5c5e-9f6d-3a0b8c7d6e5f', 'b2c3d4e5-f6a7-5b6c-9d0e-2b3c4d5e6f7g', 'The factory has approved your sample. Would you like to proceed with the order?', NOW() - INTERVAL '2 days'),
  ('c3d4e5f6-a7b8-c9d0-e1f2-3a4b5c6d7e8f', 'f3e9d8a1-2h5c-6d6f-0e7e-4b1c9d8e7f6g', 'c3d4e5f6-a7b8-6c7d-0e1f-3c4d5e6f7a8h', 'I have some questions about your sample specifications. Can we schedule a call?', NOW() - INTERVAL '1 day');

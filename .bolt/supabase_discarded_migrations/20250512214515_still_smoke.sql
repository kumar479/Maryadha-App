/*
  ...
  1. Changes
    - Add missing foreign key constraints for orders table
    - Add missing foreign key constraints for samples table
    - Add missing foreign key constraints for messages table
    - Add missing foreign key constraints for group_chats table
    - Add missing foreign key constraints for order_issues table
    - Add missing foreign key constraints for order_feedback table
...
-- Fix group_chats table relationships
ALTER TABLE group_chats
  ADD CONSTRAINT group_chats_brand_id_fkey 
  FOREIGN KEY (brand_id) REFERENCES brands(id) ON DELETE CASCADE,
  ADD CONSTRAINT group_chats_factory_id_fkey 
